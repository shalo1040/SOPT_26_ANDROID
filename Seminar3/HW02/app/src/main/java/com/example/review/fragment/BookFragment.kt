...
import com.example.review.adapter.BookAdapter
...
class BookFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //구분선
        val horizontalDivider = DividerItemDecoration(view.context, 0);
        rv_book.addItemDecoration(horizontalDivider);

        val verticalDivider = DividerItemDecoration(view.context, 1);
        rv_book.addItemDecoration(verticalDivider);
